...
const DeleteSales = ({ saleId }: { saleId: string }) => {
  const [isDeleteOpen, setIsDeleteOpen] = useState(false);

  const { isDeleting, deleteSale } = useSalesStore();
      ...
      >
        <div className="space-y-4">
          ...
          <div className="flex justify-end space-x-3">
            ...
            <Button onClick={handleDelete} variant="destructive" className="hover:cursor-pointer">
              Delete
            </Button>
          </div>
        </div>
